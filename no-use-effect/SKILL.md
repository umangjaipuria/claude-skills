...
name: no-use-effect
description: |
  Avoid useEffect as a best practice. 
  Use this skill when writing React components or refactoring existing useEffect calls or when explicitly asked to remove useEffect.
